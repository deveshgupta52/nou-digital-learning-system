    ...
    <div>
      <div className="row orange py-3 dotted-line">
        ...
        <div className="col-md-2 d-flex">
          <div><i className="fa-solid fa-phone fa-shake fa-sm me-2 theme-text-white"></i></div>
          <span className="theme-text-white fs-6">+91 9876543210</span>
        </div>
        <div className="col-md-2"></div>
        <div className="col-md-4  d-flex px-5">
          <div><i className="fa-solid fa-envelope fa-bounce fa-sm me-2 theme-text-white"></i></div>
          <span className="theme-text-white fs-6">support@digitalassessment.edu</span>
        </div>
        <div className="col-md-1"></div>
        <div className="col-md-2">
          <span className="theme-text-white fs-6">{new Date().toLocaleDateString('en-US', { 
            weekday: 'long', 
            year: 'numeric', 
            month: 'long', 
            day: 'numeric' 
      ...
      <div className="row orange dotted-line py-2">
        <p className="text-center fw-bold theme-text-white mb-0">
          For Digital Assessment and System Support, Contact our helpline: 9876543210, 9876543211, 011-12345678
        </p>
      </div>
