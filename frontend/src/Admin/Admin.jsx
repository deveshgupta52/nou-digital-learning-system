...
const AdminDashboard = () => {
  ...
  const quickActions = [
    { icon: <Plus size={20} />, label: 'Add Student', color: '#ff8c00', href: '#add-student' },
    { icon: <Plus size={20} />, label: 'Create Course', color: '#ff6b35', href: '#create-course' },
    { icon: <FileText size={20} />, label: 'New Exam', color: '#ffa500', href: '#new-exam' },
    { icon: <MessageSquare size={20} />, label: 'Post News', color: '#ffb347', href: '#post-news' }
  ];
  ...
  return (
      ...
      <div className="row " style={{ fontFamily: 'Inter, sans-serif' }}>
        ...
        {/* Main Content */}
        <div className="col-md-9 col-lg-10" style={{ backgroundColor: '#f8f9fa' }}>
          {/* Header */}
